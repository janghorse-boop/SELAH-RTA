...
# Exit 0 verifies locking and capped failed-release accounting for both manual and autonomous endings.
...
$files += Join-Path $PSScriptRoot 'AutoEndReviewProbe.kt'
...
& $Java -cp "$classes;$cp" kr.joa.selahrta.audio.AutoEndReviewProbeKt
exit $LASTEXITCODE
