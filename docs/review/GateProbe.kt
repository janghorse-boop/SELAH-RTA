...
fun main() {
    ...
    check(after.meter.currentSpl == null && after.rta == null && after.diagnostics.frames == 0L)
    println("Confirmed stop snapshot regression using unmodified CaptureController and production state composition.")
