...
data class CaptureDiagnostics(
    ...
    /**
     * 최근 덩어리의 RMS(0..1). **Peak 와 함께 봐야 뜻이 있다.**
     *
     * Peak 만 보면 툭 튄 소리 하나로 「크다」고 읽히고, RMS 만 보면
     * 잘리고 있는데도 「여유 있다」고 읽힌다. 둘의 차이가 곧 헤드룸이다
     * (USB 오디오 지시서 6장).
     */
     ...
     *
     * 0 이 아니라고 경고할 일은 아니다 — 조용한 방은 원래 그렇다.
     * 오래 이어지면 케이블·팬텀전원을 볼 자리다.
     */
    val quietMs: Long = 0L,
    /**
